...
class DisplayService:
    ...
    def print_welcome_screen(self, user_name: str):
        # clear the termonal
        os.system(
            'cls' if os.name == 'nt' else 'clear')  # clears screen with 'cls' on windows and with 'clear' for Unix systems like OS on mac or LINUX
    ...
    {RESET}
        ...
        centered_art = self.center_text(welcome_art, terminal_width)
        ...
        centered_welcome_message = self.center_text(welcome_message, terminal_width)
        centered_test_message = self.center_text(test_message, terminal_width)
        centered_ready_message = self.center_text(ready_message, terminal_width)
        # centered_rules_message = center_text(rules_message, terminal_width)
        centered_goodluck_message = self.center_text(goodluck_message, terminal_width)
        ...
        print(f"\nHello,{self.gold} {user_name} {RESET}! Let's begin the game!\n")